...
export const bookletFr: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.value.edgeStrategyTrochoidal': 'Trochoïdal',
  ...
  'booklet.label.edgeStrategy': 'Stratégie de contour',
  'booklet.label.trochoidalCutWidth': 'Largeur de coupe trochoïdale',
  'booklet.label.trochoidalOrbitRadius': 'Rayon orbital',
  'booklet.label.trochoidalAdvance': 'Avance par tour',
