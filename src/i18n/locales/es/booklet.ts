...
export const bookletEs: Record<keyof typeof bookletEn, string> = {
  ...
  "booklet.value.edgeStrategyContour": "Contorno",
  "booklet.value.edgeStrategyTrochoidal": "Trocoidal",
  ...
  "booklet.label.edgeStrategy": "Estrategia de borde",
  "booklet.label.trochoidalCutWidth": "Ancho de corte trocoidal",
  "booklet.label.trochoidalOrbitRadius": "Radio orbital",
