...
export const warningsFr: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.edgeTrochoidalWidthTooSmall': 'La largeur de coupe trochoïdale doit être supérieure au diamètre de l’outil',
  'warnings.edgeTrochoidalAdvanceRange': 'L’avance trochoïdale par tour doit être supérieure à 0 et ne pas dépasser un diamètre d’outil',
  'warnings.edgeTrochoidalInvalidGuide': 'Le canal trochoïdal demandé ne permet pas de créer un guide décalé continu',
  'warnings.edgeTrochoidalMoveBudget': 'La trajectoire trochoïdale contiendrait trop de mouvements ; augmentez l’avance par tour ou réduisez la largeur de coupe',
  'warnings.edgeTrochoidalEntryBudget': 'L’entrée orbitale contiendrait trop de mouvements ; augmentez l’angle d’entrée ou réduisez le nombre de niveaux de profondeur',
  'warnings.edgeTrochoidalRegionUnsupported': 'L’ébauche trochoïdale ne peut pas utiliser de filtres de région tant qu’une rentrée orbitale sûre après découpe n’est pas prise en charge',
  'warnings.edgeTrochoidalObstacleUnsupported': 'L’ébauche trochoïdale ne peut pas fonctionner quand d’autres entités ajout/modèle protégées imposent une découpe du parcours',
  'warnings.edgeTrochoidalPlungeEntry': 'L’entrée en plongée exige un outil à coupe au centre ou un trou d’entrée préalablement dégagé',
  'warnings.edgeTrochoidalTabsRequireHelix': 'L’ébauche trochoïdale avec attaches exige une entrée hélicoïdale pour une rentrée sûre après chaque attache',
  'warnings.edgeTrochoidalTabUnsafe': 'Une attache ne laisse aucun fragment trochoïdal ni aucune cavité de rentrée hélicoïdale sûrs ; ajustez l’attache ou les paramètres de coupe',
  ...
  'warnings.restTrochoidalUnsupported': 'L’usinage de reprise depuis un canal trochoïdal n’est pas encore pris en charge',
}
