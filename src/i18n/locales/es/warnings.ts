...
export const warningsEs: Record<keyof typeof warningsEn, string> = {
  ...
  "warnings.edgeTrochoidalWidthTooSmall": "El ancho de corte trocoidal debe ser mayor que el diámetro de la herramienta.",
  "warnings.edgeTrochoidalAdvanceRange": "El avance trocoidal por vuelta debe ser mayor que 0 y no superar un diámetro de herramienta.",
  "warnings.edgeTrochoidalInvalidGuide": "No se pudo generar una guía desplazada continua para el canal trocoidal solicitado.",
  "warnings.edgeTrochoidalMoveBudget": "La trayectoria trocoidal tendría demasiados movimientos; aumente el avance por vuelta o reduzca el ancho de corte.",
  "warnings.edgeTrochoidalEntryBudget": "La entrada orbital tendría demasiados movimientos; aumente el ángulo de entrada o reduzca el número de niveles de profundidad.",
  "warnings.edgeTrochoidalRegionUnsupported": "El desbaste trocoidal no puede usar filtros de región hasta admitir una reentrada orbital segura después del recorte.",
  "warnings.edgeTrochoidalObstacleUnsupported": "El desbaste trocoidal no puede ejecutarse cuando otros elementos de adición/modelo protegidos requieren recortar la trayectoria.",
  "warnings.edgeTrochoidalPlungeEntry": "La entrada por penetración requiere una herramienta de corte central o un orificio de entrada previamente despejado.",
  "warnings.edgeTrochoidalTabsRequireHelix": "El desbaste trocoidal con pestañas requiere entrada helicoidal para reentrar con seguridad después de cada pestaña.",
  "warnings.edgeTrochoidalTabUnsafe": "Una pestaña no deja un fragmento trocoidal ni una cavidad de reentrada helicoidal seguros; ajuste la pestaña o los parámetros de corte.",
  ...
  "warnings.restTrochoidalUnsupported": "El mecanizado de restos desde un canal trocoidal aún no es compatible",
}
