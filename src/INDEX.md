...
- [platform/](platform/) — platform abstraction (web vs Tauri), desktop integration, path helpers, feature clipboard helpers, and hidden-iframe HTML printing (`printDocument.ts`)
