...
export const bookletZhCN: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.value.edgeStrategyContour': '轮廓',
  'booklet.value.edgeStrategyTrochoidal': '摆线',
  ...
  'booklet.label.edgeStrategy': '沿边策略',
  'booklet.label.trochoidalCutWidth': '摆线切削宽度',
  'booklet.label.trochoidalOrbitRadius': '摆动半径',
  'booklet.label.trochoidalAdvance': '每圈前进量',
