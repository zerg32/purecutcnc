...
export const bookletDe: Record<keyof typeof bookletEn, string> = {
  ...
  'booklet.value.edgeStrategyContour': 'Kontur',
  'booklet.value.edgeStrategyTrochoidal': 'Trochoidal',
  ...
  'booklet.label.edgeStrategy': 'Kantenstrategie',
  'booklet.label.trochoidalCutWidth': 'Trochoidale Schnittbreite',
  'booklet.label.trochoidalOrbitRadius': 'Umlaufradius',
