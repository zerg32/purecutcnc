...
export const warningsZhCN: Record<keyof typeof warningsEn, string> = {
  ...
  'warnings.edgeTrochoidalWidthTooSmall': '摆线切削宽度必须大于刀具直径',
  'warnings.edgeTrochoidalAdvanceRange': '每圈摆线前进量必须大于 0 且不超过一个刀具直径',
  'warnings.edgeTrochoidalInvalidGuide': '请求的摆线通道无法生成连续的偏移导轨',
  'warnings.edgeTrochoidalMoveBudget': '摆线路径的移动数量过多；请增大每圈前进量或减小切削宽度',
  'warnings.edgeTrochoidalEntryBudget': '轨道进刀的移动数量过多；请增大进刀角度或减少深度层数',
  'warnings.edgeTrochoidalRegionUnsupported': '在支持裁剪后的安全轨道重新进刀前，摆线沿边粗加工不能使用区域过滤器',
  'warnings.edgeTrochoidalObstacleUnsupported': '当其他受保护的添加/模型特征需要裁剪刀路时，无法执行摆线沿边粗加工',
  'warnings.edgeTrochoidalPlungeEntry': '垂直进刀需要可中心切削的刀具或预先清出的进刀孔',
  'warnings.edgeTrochoidalTabsRequireHelix': '带夹桥的摆线粗加工需要螺旋进刀，以便在每个夹桥后安全重新进刀',
  'warnings.edgeTrochoidalTabUnsafe': '夹桥未留下安全的摆线片段或螺旋重新进刀空间；请调整夹桥或切削设置',
  ...
  'warnings.restTrochoidalUnsupported': '暂不支持从摆线扫掠通道创建残料加工',
}
