...
export const camZhCN: Record<keyof typeof camEn, string> = {
  ...
  'cam.operation.trochoidalAdvance': '每圈前进量（刀具比例）',
  'cam.operation.trochoidalAdvanceDistance': '每圈实际前进量：{distance}',
  'cam.operation.restTrochoidalUnavailable': '暂不支持从摆线扫掠通道创建残料加工。',
  'cam.operation.tabsTrochoidalUnavailable': '在验证摆线刀路的夹桥间隙前，自动放置夹桥已禁用。',
  ...
  'cam.opDesc.edgeRouteInside.keyPoint.2': '粗加工支持轮廓或摆线清槽；精加工沿轮廓运行',
  ...
  'cam.opDesc.edgeRouteOutside.keyPoint.2': '粗加工支持轮廓或摆线清槽；精加工沿轮廓运行',
